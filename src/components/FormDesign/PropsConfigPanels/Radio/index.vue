 ...
 * @LastEditors: Anxure
 * @LastEditTime: 2021-03-05 15:04:51
-->
<template>
  <a-form>
    ...
    <a-form-item label="默认值">
      <a-select v-model="formData.options.defaultValue">
        <a-select-option
    ...
    <a-form-item
      label="是否实色填充"
      v-if="formData.options.type === 'button'"
    >
      <a-radio-group
        v-model="formData.options.buttonStyle"
        button-style="solid"
      >
        <a-radio-button value="outline">否</a-radio-button>
        <a-radio-button value="solid">是</a-radio-button>
      </a-radio-group>
    </a-form-item>
